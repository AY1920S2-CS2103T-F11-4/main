...
|`* * *` |person with seafood allergy |cook meals that don't contain seafood |I do not have an allergic reaction

|`* *` |cooking enthusiast |edit recipes |I can tweak a recipe to my liking
...
|`*` |kiasu parent |know how much ingredients I need for 2 weeks |my family can survive an epidemic
...
```
Use Case: UC02 - View Recipes

MSS:
1. User chooses to view recipes.
2. Cooking Papa requests for input.
3. User enters the index of the desired recipe.
4. Cooking Papa displays the entire recipe with the corresponding index.
Use case ends.
```
```
Use Case: UC08 - Search Recipes

MSS:
1. User chooses to search recipes.
2. Cooking Papa requests for input.
3. User enters the keyword to be searched.
4. Cooking Papa displays recipes with the corresponding keyword.
Use case ends.

Extensions:
    3a. User enters the tag to be searched.
        3a1. Cooking Papa displays the recipes with the corresponding tags.
        Use case ends.
=======
